...
#include "eufs_msgs/msg/detail/mpc_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::MPCState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::MPCState & ros_message)
{
  // Member: exitflag
  cdr >> ros_message.exitflag;
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::MPCState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::MPCState *>(
    untyped_ros_message);
...
static size_t _MPCState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_MPCState(full_bounded, is_plain, 0);
...
get_message_type_support_handle<eufs_msgs::msg::MPCState>()
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_MPCState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, MPCState)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_MPCState__handle;
}
