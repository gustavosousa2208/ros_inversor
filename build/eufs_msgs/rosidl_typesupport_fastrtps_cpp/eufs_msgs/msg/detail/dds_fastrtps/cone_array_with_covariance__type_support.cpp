...
#include "eufs_msgs/msg/detail/cone_array_with_covariance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::ConeArrayWithCovariance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::ConeArrayWithCovariance & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::ConeArrayWithCovariance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::ConeArrayWithCovariance *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConeArrayWithCovariance__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::ConeArrayWithCovariance *>(
...
static size_t _ConeArrayWithCovariance__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ConeArrayWithCovariance(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ConeArrayWithCovariance__callbacks = {
  "eufs_msgs::msg",
...
static rosidl_message_type_support_t _ConeArrayWithCovariance__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConeArrayWithCovariance__callbacks,
...
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_ConeArrayWithCovariance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, ConeArrayWithCovariance)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_ConeArrayWithCovariance__handle;
}
