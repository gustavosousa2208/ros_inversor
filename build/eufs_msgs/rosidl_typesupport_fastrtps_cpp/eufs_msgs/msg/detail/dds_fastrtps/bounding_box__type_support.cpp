...
#include "eufs_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::BoundingBox & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
get_message_type_support_handle<eufs_msgs::msg::BoundingBox>()
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, BoundingBox)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
