...
#include "eufs_msgs/msg/detail/cone_with_covariance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::ConeWithCovariance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::ConeWithCovariance & ros_message)
{
  // Member: point
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::ConeWithCovariance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::ConeWithCovariance *>(
    untyped_ros_message);
...
static size_t _ConeWithCovariance__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ConeWithCovariance(full_bounded, is_plain, 0);
...
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_ConeWithCovariance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, ConeWithCovariance)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_ConeWithCovariance__handle;
}
