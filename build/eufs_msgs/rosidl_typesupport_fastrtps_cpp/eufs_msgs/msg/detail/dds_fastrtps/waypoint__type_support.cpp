...
#include "eufs_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::Waypoint & ros_message)
{
  // Member: position
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<eufs_msgs::msg::Waypoint>()
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, Waypoint)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
