...
#include "eufs_msgs/msg/detail/point_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::PointArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::PointArray & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::PointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::PointArray *>(
    untyped_ros_message);
...
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, PointArray)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
