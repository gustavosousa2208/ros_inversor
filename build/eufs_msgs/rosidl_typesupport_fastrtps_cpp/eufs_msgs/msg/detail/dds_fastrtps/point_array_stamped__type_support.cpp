...
#include "eufs_msgs/msg/detail/point_array_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::PointArrayStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::PointArrayStamped & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::PointArrayStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::PointArrayStamped *>(
    untyped_ros_message);
...
get_message_type_support_handle<eufs_msgs::msg::PointArrayStamped>()
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_PointArrayStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, PointArrayStamped)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_PointArrayStamped__handle;
}
