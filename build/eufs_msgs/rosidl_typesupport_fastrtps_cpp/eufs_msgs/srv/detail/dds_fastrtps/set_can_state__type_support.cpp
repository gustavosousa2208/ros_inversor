...
static size_t _SetCanState_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_SetCanState_Request(full_bounded, is_plain, 0);
...
static size_t _SetCanState_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_SetCanState_Response(full_bounded, is_plain, 0);
