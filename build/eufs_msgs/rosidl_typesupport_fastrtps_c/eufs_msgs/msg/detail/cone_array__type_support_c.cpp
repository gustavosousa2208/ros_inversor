...
#include "eufs_msgs/msg/detail/cone_array__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // big_orange_cones, blue_cones, orange_cones, unknown_color_cones, yellow_cones
...
using _ConeArray__ros_msg_type = eufs_msgs__msg__ConeArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ConeArray__ros_msg_type * ros_message = static_cast<const _ConeArray__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ConeArray__ros_msg_type * ros_message = static_cast<_ConeArray__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: big_orange_cones
  {
    ...
    if (ros_message->big_orange_cones.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->big_orange_cones);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->big_orange_cones, size)) {
      fprintf(stderr, "failed to create array for field 'big_orange_cones'");
      return false;
    }
    auto array_ptr = ros_message->big_orange_cones.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: unknown_color_cones
  {
    ...
    if (ros_message->unknown_color_cones.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->unknown_color_cones);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->unknown_color_cones, size)) {
      fprintf(stderr, "failed to create array for field 'unknown_color_cones'");
      return false;
    }
    auto array_ptr = ros_message->unknown_color_cones.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_eufs_msgs__msg__ConeArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ConeArray__ros_msg_type * ros_message = static_cast<const _ConeArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ConeArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__ConeArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t max_serialized_size_eufs_msgs__msg__ConeArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ConeArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_eufs_msgs__msg__ConeArray(
...
static message_type_support_callbacks_t __callbacks_ConeArray = {
  "eufs_msgs::msg",
  "ConeArray",
...
static rosidl_message_type_support_t _ConeArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ConeArray,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, msg, ConeArray)() {
  return &_ConeArray__type_support;
}
