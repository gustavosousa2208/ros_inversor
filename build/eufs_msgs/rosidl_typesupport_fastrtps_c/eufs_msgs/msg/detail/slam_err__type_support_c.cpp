...
#include "eufs_msgs/msg/detail/slam_err__rosidl_typesupport_fastrtps_c.h"
...
using _SLAMErr__ros_msg_type = eufs_msgs__msg__SLAMErr;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SLAMErr__ros_msg_type * ros_message = static_cast<const _SLAMErr__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: x_orient_err
  {
    cdr << ros_message->x_orient_err;
  }

  // Field name: y_orient_err
  {
    cdr << ros_message->y_orient_err;
  }

  // Field name: z_orient_err
  {
    cdr << ros_message->z_orient_err;
  }

  // Field name: w_orient_err
  {
    cdr << ros_message->w_orient_err;
  }

  // Field name: map_similarity
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SLAMErr__ros_msg_type * ros_message = static_cast<_SLAMErr__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_eufs_msgs__msg__SLAMErr(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SLAMErr__ros_msg_type * ros_message = static_cast<const _SLAMErr__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SLAMErr__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__SLAMErr(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t max_serialized_size_eufs_msgs__msg__SLAMErr(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SLAMErr__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_eufs_msgs__msg__SLAMErr(
...
static message_type_support_callbacks_t __callbacks_SLAMErr = {
  "eufs_msgs::msg",
  "SLAMErr",
...
static rosidl_message_type_support_t _SLAMErr__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, msg, SLAMErr)() {
  return &_SLAMErr__type_support;
}
