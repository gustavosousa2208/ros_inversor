...
#include "eufs_msgs/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "eufs_msgs/msg/detail/bounding_box__functions.h"  // bounding_boxes
#include "std_msgs/msg/detail/header__functions.h"  // header, image_header

// forward declare type support functions
size_t get_serialized_size_eufs_msgs__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_eufs_msgs__msg__BoundingBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, msg, BoundingBox)();
...
using _BoundingBoxes__ros_msg_type = eufs_msgs__msg__BoundingBoxes;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounding_boxes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, eufs_msgs, msg, BoundingBox
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    if (ros_message->bounding_boxes.data) {
      eufs_msgs__msg__BoundingBox__Sequence__fini(&ros_message->bounding_boxes);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_eufs_msgs__msg__BoundingBox(
...
static uint32_t _BoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__BoundingBoxes(
  ...
  size_t current_alignment)
{
  ...
  // member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_eufs_msgs__msg__BoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _BoundingBoxes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eufs_msgs__msg__BoundingBoxes(
