  ...
  void * untyped_ros_message)
{
  ...
  // Field name: channel0
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->channel0, size)) {
      fprintf(stderr, "failed to create array for field 'channel0'");
      return false;
    }
    auto array_ptr = ros_message->channel0.data;
  ...
  // Field name: channel1
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->channel1, size)) {
      fprintf(stderr, "failed to create array for field 'channel1'");
      return false;
    }
    auto array_ptr = ros_message->channel1.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  // Field name: channel2
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->channel2, size)) {
      fprintf(stderr, "failed to create array for field 'channel2'");
      return false;
    }
    auto array_ptr = ros_message->channel2.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  // Field name: channel3
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->channel3, size)) {
      fprintf(stderr, "failed to create array for field 'channel3'");
      return false;
    }
    auto array_ptr = ros_message->channel3.data;
    cdr.deserializeArray(array_ptr, size);
...
static size_t _Costmap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eufs_msgs__msg__Costmap(
