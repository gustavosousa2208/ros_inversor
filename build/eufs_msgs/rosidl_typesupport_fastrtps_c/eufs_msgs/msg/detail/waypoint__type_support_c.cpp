...
#include "eufs_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = eufs_msgs__msg__Waypoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: suggested_steering
  {
    cdr << ros_message->suggested_steering;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name suggested_steering
  {
    size_t item_size = sizeof(ros_message->suggested_steering);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__Waypoint(
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eufs_msgs__msg__Waypoint(
